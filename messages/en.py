...
messages = {
    ...
    "start_message": "Welcome to Fake Digits Bot! Please choose your preferred language:",
    "choose_language": "Please choose your preferred language 🌐:",
    # ... (More messages)
    "category_menu_message": "Please choose a category:",
    "select_country_message": "Please select a country:",
    "no_servers_available_for_country": "Sorry, no servers available for this country at the moment. Please try another country.",
    "select_server_message": "Please select a server:",
    "balance_insufficient": "Your balance is insufficient to complete this operation. Current balance: {balance} {currency}. Please top up and try again.",
    "purchase_success": "Number purchased successfully!\nNumber: <code>{number}</code>\nPrice: {price} {currency}\nNote: If the code does not arrive, you can request another number or contact support.",
    "error_processing_request_user": "An error occurred while processing your request. Please try again later or contact support.",
    "no_numbers_available_in_server": "Sorry, no numbers are available in the selected server at the moment. Please choose another server or country.",
    "failed_to_get_number": "Sorry, failed to get a number from the service provider. Please try again.",
    "number_expired_or_no_code": "No code received for this number or it has expired. Please try another number or contact support.",
    "processing_request": "Processing your request... Please wait a moment.",
    "fetching_data": "Fetching data... Please wait.",
    "request_cancelled": "Operation cancelled.",
    "not_allowed_in_channel": "Sorry, the bot is not allowed in this channel. Please use it in private chat.",
    "offers_title": "✨ Available Offers ✨",
    "no_offers_available": "Sorry, no offers are available at the moment.",
    "available_offers_list": "List of available offers:",
    "offer_entry": "- {platform} - {country} - {server_name}: {price} {currency} ({quantity} available)",
    "your_balance_is": "Your current balance: {balance} {currency}.",
    "all_offers_button": "All Offers",
    "whatsapp_offers_button": "WhatsApp Offers",
    "telegram_offers_button": "Telegram Offers",
    "general_offers_title": "🎁 Special Number Offers 🎁",
    "general_offers_whatsapp_telegram": "Browse the best WhatsApp and Telegram number offers at unbeatable prices.",
    "general_offers_best_prices": "We provide you with the best prices for currently available temporary numbers.",
    "choose_platform_for_offers_prompt": "Please choose a platform to view offers:",
    "offer_button_label_new": "{flag} {country_name} - {platform} - {price} {currency} ({quantity} available)",
    "view_more_offers_button": "View More Offers...",
    # ... (Many other messages)
