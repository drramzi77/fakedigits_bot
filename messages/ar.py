...
messages = {
    ...
    "back_to_dashboard_button_text": "🔙 العودة ", # نص زر العودة من قائمة اختيار التطبيق الى لوحة التحكم الرئيسية
    ...
    "back_to_main_menu_error": "🔙 العودة ", # لم يعد يستخدم بشكل مباشر في الكود الجديد، يستبدل بـ back_to_dashboard_button_text
